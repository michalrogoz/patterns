...
public class BookStoreFacadeTest extends AbstractClientTest {
    ...
    public void testPlaceOrder() {
        ...
        ((BookstoreFacadeImpl) facade).setBookDBService(bookService);
        ((BookstoreFacadeImpl) facade).setCustomerDBService(customerService);
        ((BookstoreFacadeImpl) facade).setOrderingService(orderingService);
        ((BookstoreFacadeImpl) facade).setWharehouseService(warehouseService);
        ((BookstoreFacadeImpl) facade).setCustomerNotificationService(customerNotificationService);
    ...
    protected BookstoreFacade createFacade() {
        ...
        return new BookstoreFacadeImpl();
    }
}
